 ...
 */
import { UsersPermissionsPermissionListResponseDataItemAttributesRoleDataAttributes } from './usersPermissionsPermissionListResponseDataItemAttributesRoleDataAttributes';
